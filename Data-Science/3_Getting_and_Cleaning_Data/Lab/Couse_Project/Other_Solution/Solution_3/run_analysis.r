...
feature_list<-read.table("Raw_Data/features.txt")
...
test_dataset<-read.table("Raw_Data/test/X_test.txt")
...
test_activities<-read.table("Raw_Data/test/Y_test.txt")
...
train_dataset<-read.table("Raw_Data/train/X_train.txt")
...
#=========================================================================================
write.csv(tidy_dataset, "Data/processed_data.csv")